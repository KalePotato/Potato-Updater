...
7. Use the external test environment selected by `POTATO_TEST_CORE`; never hardcode a personal launcher or drive path.
8. Apply the same build, test, security, and repository-hygiene standards to every change regardless of its source.
